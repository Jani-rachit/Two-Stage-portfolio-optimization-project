...
# 🔥 FIXED EXPERIMENT SETTINGS (For Baseline)
...
for seq_len in SEQ_LENGTHS:
    for model_type in MODEL_TYPES:
        print(f"\n🚀 Running: Model={model_type}, seq={seq_len}")
        ...
        for file in os.listdir(DATA_PATH):
            ...
            # IMPORTANT: We DO NOT flatten the data here.
            # Shape remains: (Batch Size, Sequence Length, Features)
...
print("\n🎉 Advanced Baseline Experiments Completed!")